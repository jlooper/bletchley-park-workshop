...
1. With your mouse, select the sprite area, like so:
   ...
   ![Select sprite from window](sprite-window.png)
...
![Player top left ](player-top-left.png)
...
1. Select **gallery** in the sprite window.
   ...
   ![Select sprite enemy](select-sprite-enemy.png)
...
1. Select the play button like so:
   ...
   ![Use joystick to move](game-move.png)
...
1. Select a block that looks like so:
   ...
   ![Collision block](collision-block.png)
...
1. Select **sprites** and select a block that looks like so:
   ...
   ![Select destroy block](destroy-block.png)
